...
class StateTag extends TagAbstract
{
    ...
    public function get(string $stateId): State
    {
        ...
        try {
            ...
            $data = $this->parser->parse((string) $body, \PSX\Schema\SchemaSource::fromClass(State::class));
    ...
    public function getAll(?int $startIndex = null, ?string $name = null): StateCollection
    {
        ...
        try {
            ...
            $data = $this->parser->parse((string) $body, \PSX\Schema\SchemaSource::fromClass(StateCollection::class));
